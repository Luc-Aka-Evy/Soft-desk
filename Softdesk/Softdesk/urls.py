...
admin_projects_router = routers.NestedSimpleRouter(
    admin_router, "admin-projects", lookup="projects"
)
...
admin_issues_router = routers.NestedSimpleRouter(
    admin_projects_router, "issues", lookup="issues"
)
